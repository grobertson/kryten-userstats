...
echo ""
echo "═══════════════════════════════════════════════════════"
echo "  Kryten User Statistics Tracker Startup"
echo "═══════════════════════════════════════════════════════"
echo ""
...
echo -e "\033[90mPrometheus metrics will be available on port 28282\033[0m"
echo -e "\033[90mPress Ctrl+C to stop\033[0m"
echo ""

exec "$VENV_PYTHON" -m userstats "$CONFIG_PATH"
